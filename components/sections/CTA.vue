<template>
  <UiSectionWrapper class="py-20 relative bg-accentColor2 text-bodyColor">
    <UiSectionContainer class="flex md:flex-row-reverse pb-8 md:pb-0">
      <div class="absolute md:relative bottom-0 right-0 z-20 h-[222px] pb-4 md:pb-0 pr-2 md:pr-0 md:h-full">
        <img src="/assets/images/products.png" alt="cta image"
        ...
        <div class="flex flex-col h-full">
          ...
          <div class="pt-7 lg:pt-[50px] flex flex-col lg:flex-row gap-2 lg:gap-10 font-medium">
            <div v-motion :initial="{ opacity: 0, y: 32 }" :visible-once="{
              ...
              <img src="/assets/images/checkmark-star.svg" alt="star icon"
